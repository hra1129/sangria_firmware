...
def main():
	...
	f.write( "\tint32_t\twidth;\n" )
	f.write( "\tint32_t\theight;\n" )
	...
	f.write( "\n" )
	f.write( "#include <sangria_glib.h>\n" )
	f.write( "\n" )
	f.write( "extern const struct _BACKBUFFER_T _%s;\n" % s_name )
	f.write( "#define p_%s ((SANGRIA_BACKBUFFER_T*) &_%s)\n" % ( s_name, s_name ) )
	f.write( "\n" )
...
if __name__ == "__main__":
	print( "Image converter for sangria_glib" )
	print( "========================================" )
	print( "2022 t.hara" )
	print( "" )
	if len( sys.argv ) < 3:
